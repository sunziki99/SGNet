...
class Eyepacs_dataset(data.Dataset):
    def __init__(self, train=True, val=False, test=False, multi=25):
        self.test = test
        self.train = train
        self.val = val
        self.multi = multi
        self.path = 'E:/Datasets/eyepacs2/'
        self.imgs = []
        ...
        if test:
            with open(self.path + 'test.txt', encoding='utf-8') as file:
                for line in file.readlines():
                    ...
                    if label != 5:
                        self.imgs.append([self.path + 'test/' + img, label])
            ...
            with open(self.path + 'valid.txt', encoding='utf-8') as file:
                for line in file.readlines():
                    ...
                    label = int(line.split(' ')[1])
                    if label != 5:
                        self.imgs.append([self.path + 'valid/' + img, label])
            ...
            with open(self.path + 'train.txt', encoding='utf-8') as file:
                for line in file.readlines():
                    ...
                    label = int(line.split(' ')[1])
                    if label != 5:
                        self.imgs.append([self.path + 'train/' + img, label])
...
if __name__ == '__main__':
    dst = Eyepacs_dataset(train=True, val=False, test=False, multi=5)
